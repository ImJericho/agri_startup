...
class AgmarknetScraper:
    ...
    def find_all_commodities(self, do_save=False):
        ...
        for commodity in commodity_list:
            print(commodity)
        if do_save:
            self.save_to_csv(commodity_list, 'backend/data/metadata/commodity_list.csv')
    ...
    def find_all_states(self, do_save=False):
        ...
        if do_save:
            self.save_to_csv(state_list, 'backend/data/metadata/state_list.csv')
        return state_list
    ...
    def find_all_districts(self, state_name, do_save=False):
        ...
        if do_save:
            self.save_to_csv(district_list, 'backend/data/metadata/district_list.csv')
    ...
    def find_all_markets(self, state_name, district_name, do_save=False):
        ...
        if do_save:
            self.save_to_csv(market_list, '../data/metadata/market_list.csv')
        return market_list
...
if __name__ == "__main__":
    ...
    df.to_csv('../data/metadata/market_list.csv', index=False)
